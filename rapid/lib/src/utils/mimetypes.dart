...
abstract class MimeTypes {
  ...
  static String? ofFile(File file, {Iterable<MimeTypeDetector>? detectors}) {
    if (detectors != null) {
      final mimeType = detectors.map((e) => e(file)).firstWhere((mime) => mime != null, orElse: () => null);
      if (mimeType != null) {
        return mimeType;
      }
    }
...
class MimeType {
  ...
  bool operator ==(Object other) => other is MimeType && other.mimeType == mimeType;
